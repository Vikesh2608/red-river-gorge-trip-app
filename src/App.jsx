...
const TABLES={members:'trip_members',expenses:'trip_expenses',comments:'trip_comments',posts:'trip_posts',trackers:'trip_trackers'};
...
const loadRealtime = async()=>{
 const [{data:m},{data:e},{data:c},{data:p},{data:t}] = await Promise.all([
 ...
 setMembers(m||[]); setExpenses(e||[]); setComments(c||[]); setPublicPosts(p||[]); setLiveTrackers(t||[]);
