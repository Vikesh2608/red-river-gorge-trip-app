...
return <div style={{padding:18,fontFamily:'-apple-system,BlinkMacSystemFont,Arial,sans-serif',background:'linear-gradient(180deg,#020617,#0f172a,#1d4ed8,#7c3aed,#f8fafc)',minHeight:'100vh',paddingBottom:110,letterSpacing:'-0.01em',animation:'fadeIn .35s ease'}}>
